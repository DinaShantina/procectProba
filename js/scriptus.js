...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 bgAbout">
        ...
        <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12 TextBgAbout">
            ...
            <h2 class="tileH2 text-shadow-drop-center">Ајде заедно да го промениме начинот на кој учиме!
            </h2>
            <br>
            ...
            <h2 class="tileH2 text-shadow-drop-center">Нашата визија е да го претвориме целиот град во
                универзитет,
                секој
                простор во
                училница и секој
